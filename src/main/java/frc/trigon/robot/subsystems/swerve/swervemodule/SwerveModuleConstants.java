...
public class SwerveModuleConstants {
    ...
    static TalonFXConfiguration generateDriveMotorConfiguration() {
        ...
        config.Slot0.kS = RobotHardwareStats.isSimulation() ? 0.0010955 : 0.26511;
        config.Slot0.kV = RobotHardwareStats.isSimulation() ? 0.74583 : 0.88113;
        config.Slot0.kA = RobotHardwareStats.isSimulation() ? 0.01247 : 0.068927;
    ...
    static TalonFXConfiguration generateSteerMotorConfiguration(int feedbackRemoteSensorID) {
        ...
        config.Slot0.kP = RobotHardwareStats.isSimulation() ? 120 : 50;
        config.Slot0.kI = RobotHardwareStats.isSimulation() ? 0 : 0;
        config.Slot0.kD = RobotHardwareStats.isSimulation() ? 0 : 0;
