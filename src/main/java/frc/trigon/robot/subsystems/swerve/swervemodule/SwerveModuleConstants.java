...
public class SwerveModuleConstants {
    ...
    static TalonFXConfiguration generateDriveMotorConfiguration() {
        ...
        config.Slot0.kS = RobotHardwareStats.isSimulation() ? 0.016046 : 0.26511;
        config.Slot0.kV = RobotHardwareStats.isSimulation() ? 0.8774 : 0.88113;
        config.Slot0.kA = RobotHardwareStats.isSimulation() ? 0.020691 : 0.068927;
