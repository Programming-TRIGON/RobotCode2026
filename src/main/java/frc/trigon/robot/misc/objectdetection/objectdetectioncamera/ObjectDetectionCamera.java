...
public class ObjectDetectionCamera extends SubsystemBase {
    ...
    private Translation2d calculateObjectPositionFromRotation(Rotation3d objectRotation) {
        final Pose2d robotPoseAtResultTimestamp = RobotContainer.ROBOT_POSE_ESTIMATOR.samplePoseAtTimestamp(objectDetectionCameraInputs.latestResultTimestamp).toPose2d();
