...
public class OperatorConstants {
    ...
    public static final Trigger //General Triggers
            ...
            SHOOTING_SAFE_DRIVE_TRIGGER = DRIVER_CONTROLLER.start(),
            TRENCH_ASSIST_TRIGGER = DRIVER_CONTROLLER.leftStick(),
    ...
    public static final Trigger //Intake Triggers
            ...
            TOGGLE_SHOULD_KEEP_INTAKE_OPEN_TRIGGER = OPERATOR_CONTROLLER.u(),
    ...
    public static final Trigger //Climb Triggers
            OPEN_CLIMBER_TRIGGER = DRIVER_CONTROLLER.start().or(OPERATOR_CONTROLLER.c()).multiPress(2, DOUBLE_TAP_TIMEOUT_SECONDS),
    ...
    public static final Trigger //Debugging Triggers
            UNJAM_TRIGGER = DRIVER_CONTROLLER.back().or(OPERATOR_CONTROLLER.q()),
            SHORT_EJECTION_TRIGGER = DISABLE_AUTO_SHOOT_TRIGGER.and(DRIVER_CONTROLLER.x().or(OPERATOR_CONTROLLER.e())),
