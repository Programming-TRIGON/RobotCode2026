...
public class OperatorConstants {
    ...
    public static final Trigger //General Triggers
            ...
            SHOOTING_SAFE_DRIVE_TRIGGER = DRIVER_CONTROLLER.leftStick().multiPress(2, DOUBLE_TAP_TIMEOUT_SECONDS),
            TRENCH_ASSIST_TRIGGER = DRIVER_CONTROLLER.leftStick().and(SHOOTING_SAFE_DRIVE_TRIGGER.negate()),
