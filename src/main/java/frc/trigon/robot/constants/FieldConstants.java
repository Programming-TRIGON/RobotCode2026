...
public class FieldConstants {
    ...
    private static final double
            ...
            INTAKE_X = 7.4,
            INTAKE_Y = 7.3,
            NO_VISIBLE_OBJECTS_INTAKE_X = 7.7,
    ...
    public static final FlippablePose2d
            ...
            NO_VISIBLE_OBJECTS_INTAKE_POSITION = new FlippablePose2d(NO_VISIBLE_OBJECTS_INTAKE_X, FIELD_WIDTH_METERS / 2, Rotation2d.fromDegrees(0), true),
