...
public class GamePieceAutoDriveConstants {
    ...
    static final double MAX_COLLECTION_X_METERS = FieldConstants.FIELD_LENGTH_METERS;// (FieldConstants.FIELD_LENGTH_METERS / 2.0) + 0.5; // 0.5m buffer beyond mid-field line. This is commented out because in the auditions there's no opposing alliance so we can pass the line.
